...
class Home extends Component {
    ...
    componentDidMount() {
        axios.get(`http://127.0.0.1:8000/cake/`)
            .then(result => {
    ...
    handleSumbitNewIngredient = (evet) => {
        ...
        axios.post(`http://127.0.0.1:8000/cake/`, newIngredient)
            .then(result => {
                console.log(result);
    ...
    handleSearchSumbit = event => {
        ...
        axios.get(`http://127.0.0.1:8000/cake/?contains=${text}`)
            .then(result => {
